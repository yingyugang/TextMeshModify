...
namespace BlueNoah
{
	...
	public class TextMeshSpiral : TextMeshMotionBase
	{
		...
		public float cycleIntervalFactor = 0.2f;
		...
		IEnumerator Spiral(string text)
		{
			...
			while (true)
			{
				...
				for (int i = 0; i < textInfo.characterCount; i++)
				{
					...
					if (height - i > 0)
					{
						destinationVertices[vertexIndex + 0] = myVector * radius + new Vector3(0, (height - i) * cycleIntervalFactor, 0);
						destinationVertices[vertexIndex + 1] = sourceVertices[vertexIndex + 1] - sourceVertices[vertexIndex] + myVector * radius + new Vector3(0, (height - i) * cycleIntervalFactor, 0);
						destinationVertices[vertexIndex + 2] = sourceVertices[vertexIndex + 2] - sourceVertices[vertexIndex] + myVector * radius + new Vector3(0, (height - i) * cycleIntervalFactor, 0);
						destinationVertices[vertexIndex + 3] = sourceVertices[vertexIndex + 3] - sourceVertices[vertexIndex] + myVector * radius + new Vector3(0, (height - i) * cycleIntervalFactor, 0);
